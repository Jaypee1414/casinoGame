          ...
          <div className=" inset-0 flex items-center justify-center z-50 h-[90vh]">
            ...
            <div className="w-[30rem] h-[20rem] sm:w-[30rem] sm:h-[15rem] md:w-[40rem] md:h-[18rem] lg:w-[50rem] lg:h-[20rem] xl:w-[80rem] xl:h-[40rem] 2xl:w-[90rem] 2xl:h-[40rem] text-center mt-[25px] sm:mt-[20px] md:mt-[1px] lg:mt-[-120px] xl:mt-[20px] 2xl:mt-[20px]">
              ...
              >
                ...
                <h3 className="bg-clip-text text-transparent bg-text-gradient font-bold mb-[-18px]">Choose Your Game Mode</h3>
                <div className="flex flex-row gap-5 justify-center w-full ">
                  ...
                  <button className="bg-[url('/image/playbotButton.svg')] bg-no-repeat bg-center bg-cover sm:bg-contain md:bg-cover lg:bg-cover xl:bg-cover 2xl:bg-cover w-full sm:w-auto" onClick={handleButtonClickLive}>
                    <p className="text-[12px] sm:text-[16px] md:text-[18px] lg:text-[24px] xl:text-[28px] 2xl:text-[32px] font-bold tracking-tight text-transparent text-white">Start Game</p>
                    </button>
                  </div>
                </div>
                </div>
