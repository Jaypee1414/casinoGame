...
export function PlayerHand({
  ...
  return (
    <div
      ref={containerRef}
      className={`flex flex-wrap justify-center sm:w-[300px] 2xl:w-[500px] rounded-lg absolute ${
        isCurrentPlayer
          ? "bg-opacity-10 shadow-lg h-20 sm:h-[72px] sm:ml-[-5px] sm:mt-[-56px] 2xl:h-[100px] 2xl:ml-[200px] 2xl:mt-[-15px]"
          : "bg-opacity-10 shadow-lg h-20 sm:h-[72px] sm:ml-[-5px] sm:mt-[-56px] 2xl:h-[100px] 2xl:mt-[-15px] 2xl:ml-[200px]"
      }`}
    >
      {hand?.map((card, index) => (
        <motion.div
      ...
      {isCurrentPlayer && (
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
          <div className="bg-green-500 text-white px-4 py-2 rounded-full shadow-lg animate-pulse sm:w-[80px] sm:h-[30px] sm:text-[10px]">
            Your Turn!
          </div>
        </div>
      )}
